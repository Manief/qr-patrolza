...
import { Point, PointDetails } from '../../types/patrol';
...
const QRCodePDFDoc = ({ points, getPointDetails }: { points: Point[]; getPointDetails: (id: string) => PointDetails }) => (
  <Document>
...
const QRCodePDF = ({ points, getPointDetails }: { points: Point[]; getPointDetails: (id: string) => PointDetails }) => (
